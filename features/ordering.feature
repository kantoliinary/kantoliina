Feature: order members
  ...
  Background: An admin, a membergroup and several members exist in the database
    ...
    Given the following members exist:
      ...
      | 1  | Janne      | Jaesen     | Vantaa       | Jokiniementie | 65432   | Stadi      | Finland | janne.jasen@yahoo.com      | 12345        | 1              | 2015           | true          | 2015.01.01  | true   | false   | false  | 2015.01.01   |
      | 2  | Liisa      | Mehiläinen | Espoo        | Jokintie      | 23456   | Esboo      | Finland | liisa.mehilainen@gmail.com | 12466        | 1              | 2014           | true          | 2014.01.01  | true   | false   | false  | 2014.01.01   |
      | 3  | Jaana      | Jaesen     | Espoo        | Kantajantie   | 23456   | Turku      | Zaire   | jaana.jasen@hotmail.com    | 12543        | 2              | 2013           | false         | 2013.01.01  | true   | true    | true   | 2013.01.01   |
  ...
  Scenario: I order members by post office
    ...
    And I should see "Esboo" before "Stadi"
    And I should see "Janne" before "Jaana"
    Then I click a text "#members_table thead #postoffice"
    And I should see "Stadi" before "Esboo"
  ...
  Scenario: I order members by membergroup
    ...
    Then I should see "Liisa" before "Jaana"
    And I should see "Ainaisjäsen</td" before "Varsinaisjäsen</td"
    And I click a text "#members_table thead #membergroup"
    Then I should see "Jaana" before "Liisa"
