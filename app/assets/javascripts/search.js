var search = function (options) {
    ...
    function insertdata(data, textStatus, jqXHR) {
        ...
        var columns = ["membernumber", "name", "municipality", "address", "zipcode", "postoffice", "country", "membergroup", "membershipyear", "invoicedate", "paymentstatus", "active", "support", "lender"]
