class Member < ActiveRecord::Base
  ...
  validates :membernumber, :presence => {:message => "Jasennumero puuttuu!"}, :numericality => {:only_integer => {:message => "Jasennumerossa tulee olla vain numeroita!"}}, :length => {:minimum => 3,  :maximum => 19, :message => "Jasennumeron tulee olla 3-19 merkkia pitka!"}
